...
demoVars = c("v012", "v106", "v151", "v155", "v201", "v716", "v501", "v136", "v190", "v191", "v025") # demographic variables
...
vaxcardVars = names(dhs_data)[grepl('h1_', names(dhs_data))] # indicates whether child had vaccine card
...
prepped_dhs_data <- prepped_dhs_data %>%
  ...
  mutate(dob := make_date(month=birth_month, day="1", year=birth_year))
...
# remove children that weren't born in the last three years of survey
prepped_dhs_data <- filter(prepped_dhs_data, birth_year >2010)
