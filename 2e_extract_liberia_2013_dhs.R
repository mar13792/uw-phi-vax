...
vaxcardVars = names(dhs_data)[grepl('h1', names(dhs_data))] # indicates whether child had vaccine card
...
print("Step 2d: Prepping Liberia 2016 MIS DHS data now complete.")
